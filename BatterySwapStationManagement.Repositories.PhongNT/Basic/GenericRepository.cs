...
namespace BatterySwapStationManagement.Repositories.PhongNT.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected FA25_PRN232_SE1707_G5_BatterySwapStationManagement _context;

        public GenericRepository()
        {
            _context ??= new FA25_PRN232_SE1707_G5_BatterySwapStationManagement();
        }

        public GenericRepository(FA25_PRN232_SE1707_G5_BatterySwapStationManagement context)
        {
            _context = context;
        }
